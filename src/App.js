    ...
    <>
      ...
      <div className="container idea-section">
        ...
        <div className="idea_column">
          ...
          <div className="ideas">
            <div className="icon"><img src={server} alt="i1" height={50} width={50} /></div>
            <h3>Bulk Creation </h3>
            <p>Create and edit many QR codes in no time.</p>
          </div>

          <div className="ideas">
            <div className="icon"> <img src={icon1} alt="i1" height={50} width={50} /></div>
            <h3> Scan statistics</h3>
            <p>Track your QR codes and get insights about scans.</p>
          </div>

          <div className="ideas">
            <div className="icon"><img src={brush} alt="i1" height={50} width={50} /></div>
